...
文章一覽：[連結](https://github.com/Mes0903/Cpp-Miner/blob/hackmd/SUMMARY.md)

# 前言 <img src = "https://i.imgur.com/thmVmX6.png?w=930" height = 50>

這是一本介紹 Modern C++ 與一些 C++ 深度解析的書，從我的 hackmd 搬運而來，你可以從[這裡](https://github.com/Mes0903/Cpp-Miner/blob/hackmd/SUMMARY.md)看見文章一覽。 如果您是 C++ 新手，我會建議您先去看 Miner Tutorial 的部分，裡面對初學者會學到的東西做了簡單的介紹，可以幫助大家理解、回憶一些基礎知識，同時可以讓你習慣本書風格。
...
+ [Windows 內的 C++ 與 Vscode 環境建置](https://github.com/Mes0903/Cpp-Miner/tree/hackmd/Miner_Tutorial/Environment_Building) 
+ [Object、Expression 與 Statement](https://github.com/Mes0903/Cpp-Miner/tree/hackmd/Miner_Tutorial/Object_Expression_Statement)  
+ [Array 與 Pointer](https://github.com/Mes0903/Cpp-Miner/tree/hackmd/Miner_Tutorial/Array_Pointer)   
+ [Function 與 Memory](https://github.com/Mes0903/Cpp-Miner/tree/hackmd/Miner_Tutorial/Function_Memory)   
+ [Class](https://github.com/Mes0903/Cpp-Miner/tree/hackmd/Miner_Tutorial/Class)
+ [Class 與物件導向](https://github.com/Mes0903/Cpp-Miner/tree/hackmd/Miner_Tutorial/OO)

## Cpp Miner 礦坑系列本文

### C++11、14

+ [Value Categories 值類別](https://github.com/Mes0903/Cpp-Miner/tree/hackmd/Miner_main/Value_Categories)
+ [malloc、new 與 POD Type](https://github.com/Mes0903/Cpp-Miner/tree/hackmd/Miner_main/malloc_new_POD) (部分待補)
+ [std::function](https://github.com/Mes0903/Cpp-Miner/tree/hackmd/Miner_main/Std_Function) (source code 解析部分尚未完成)

### C++17

+ [Structured Binding 結構化綁定](https://github.com/Mes0903/Cpp-Miner/tree/hackmd/Miner_main/Structured_Binding)

### C++20

+ [Concept、SFINAE 與 Detection Idiom](https://github.com/Mes0903/Cpp-Miner/tree/hackmd/Miner_main/Concept_SFINAE_DetectionIdiom)

## 礦坑內的黑魔法

+ [用 "explicit" 來偵測複製](https://github.com/Mes0903/Cpp-Miner/tree/hackmd/Miner_BlackMagic/Explicit_Detect_Copy)
+ [Small String Optimization](https://github.com/Mes0903/Cpp-Miner/tree/hackmd/Miner_BlackMagic/SSO)
+ [四個不該用 "const" 的時機](https://github.com/Mes0903/Cpp-Miner/tree/hackmd/Miner_BlackMagic/NoConst)
+ [Indirect through null pointer 是 UB 嗎?](https://github.com/Mes0903/Cpp-Miner/tree/hackmd/Miner_BlackMagic/Indirect_through_null_pointer)
...
github 上有兩個 branch，一個是 main branch，主要是用來放在我部落格上的格式，另一個是 hackmd branch，會定期跟 hackmd 上的版本做 sync，因此如果發現有錯字，可以到 hackmd 處直接修改，我會收到信件通知，並且每隔一段時間我就會搬到 github 上。

由於 hackmd branch 是直接從 hackmd 上面搬過來的，所以有些格式可能會有點怪，如果是要以正常的 README 格式讀建議到 main branch 看，或是直接到我的部落格看，我會把文章放在那裡。
...
最後是 hackmd 上的 CSS 在這裡：https://hackmd.io/aPqG0f7uS3CSdeXvHSYQKQ?both
