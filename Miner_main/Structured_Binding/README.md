...
- [3. C++ 17 結構化綁定](https://zh-blog.logan.tw/2019/10/29/cxx-17-structured-binding/) 

- [4. C++ 学习指南基础（三）](https://blog.csdn.net/LYR1994/article/details/105340773?ops_request_misc=&request_id=&biz_id=102&utm_term=Structured%20binding%20declaration&utm_medium=distribute.pc_search_result.none-task-blog-2~all~sobaiduweb~default-4-105340773.first_rank_v2_pc_rank_v29)

- [5. C++17尝鲜：结构化绑定声明（Structured Binding Declaration）](https://blog.csdn.net/zwvista/article/details/78111346?ops_request_misc=%257B%2522request%255Fid%2522%253A%2522161728731916780264014555%2522%252C%2522scm%2522%253A%252220140713.130102334..%2522%257D&request_id=161728731916780264014555&biz_id=0&utm_medium=distribute.pc_search_result.none-task-blog-2~all~sobaiduend~default-2-78111346.first_rank_v2_pc_rank_v29&utm_term=Structured+binding+declaration&spm=1018.2226.3001.4187)

- [6. C++17新特性(1) -- 结构化绑定初始化(Structured binding declaration)](https://blog.csdn.net/yangsenuestc/article/details/79840670?ops_request_misc=%257B%2522request%255Fid%2522%253A%2522161728731916780264014555%2522%252C%2522scm%2522%253A%252220140713.130102334..%2522%257D&request_id=161728731916780264014555&biz_id=0&utm_medium=distribute.pc_search_result.none-task-blog-2~all~sobaiduend~default-1-79840670.first_rank_v2_pc_rank_v29&utm_term=Structured+binding+declaration)

- [7. When does an Incomplete Type error occur in C++](https://stackoverflow.com/questions/44963201/when-does-an-incomplete-type-error-occur-in-c)

- [8. std::remove_reference](https://en.cppreference.com/w/cpp/types/remove_reference)

- [9. remove_reference 引用移除工作原理](https://www.mdeditor.tw/pl/pjYZ/zh-tw)

- [10. std::is_same](https://en.cppreference.com/w/cpp/types/is_same)
...
- [14. [C++] - 中的复制初始化(copy initialization)](https://blog.csdn.net/zqxf123456789/article/details/71582384)

- [15. Attribute specifier sequence(since C++11)](https://en.cppreference.com/w/cpp/language/attributes)

- [16. cv (const and volatile) type qualifiers](https://en.cppreference.com/w/cpp/language/cv)

- [17. Copy initialization](https://en.cppreference.com/w/cpp/language/copy_initialization)

- [18. Is there a difference between copy initialization and direct initialization?](https://stackoverflow.com/questions/1051379/is-there-a-difference-between-copy-initialization-and-direct-initialization)

- [19. Initializers](https://docs.microsoft.com/zh-tw/cpp/cpp/initializers?view=msvc-160)

- [20. What is a sub-expression in C?](https://stackoverflow.com/questions/22577679/what-is-a-sub-expression-in-c/22577708)

- [21. std::tuple_size\<std::tuple>](https://en.cppreference.com/w/cpp/utility/tuple/tuple_size)

- [22. P0144R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2015/p0144r0.pdf)

- [23. Structured bindings implementation underground and std::tuple](https://stackoverflow.com/questions/39763517/structured-bindings-implementation-underground-and-stdtuple)

- [24. Member access operators](https://en.cppreference.com/w/cpp/language/operator_member_access)

- [25. Template non-type parameters](https://www.learncpp.com/cpp-tutorial/template-non-type-parameters/)

- [26. Argument-dependent lookup](https://en.cppreference.com/w/cpp/language/adl)

- [27. Template parameters and template arguments](https://en.cppreference.com/w/cpp/language/template_parameters)

- [28. std::get(std::tuple)](https://en.cppreference.com/w/cpp/utility/tuple/get)

- [29. Structured binding declarations [dcl.struct.bind]](http://eel.is/c++draft/dcl.struct.bind#4)

- [30. Understand structured binding in C++17 by analogy](https://stackoverflow.com/questions/49795131/understand-structured-binding-in-c17-by-analogy)

- [31. Structured binding on const](https://stackoverflow.com/questions/55329651/structured-binding-on-const)

- [32. Is always the address of a reference equal to the address of origin?](https://stackoverflow.com/questions/45821678/is-always-the-address-of-a-reference-equal-to-the-address-of-origin)
